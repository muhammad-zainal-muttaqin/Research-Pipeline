...
- Hubungan dengan [Apple Flower Detection](122%20-%202020%20-%20Apple%20Flower%20Detection%20(Pruned%20YOLOv4)%20-%20Pertanian.md): Wu dkk. (2020) berfokus pada deteksi bunga apel menggunakan YOLOv4 dengan pemangkasan saluran (*channel pruning*) untuk deployment perangkat tepi berdaya rendah, berlawanan dengan Tian dkk. yang menambah kompleksitas struktural demi akurasi.
- Hubungan dengan [Apple Detection RGB+Depth (Faster R-CNN)](123%20-%202020%20-%20Apple%20Detection%20RGB+Depth%20(Faster%20R-CNN)%20-%20Pertanian.md): Fu dkk. (2020) memecahkan masalah oklusi dedaunan lebat dengan menambahkan fitur kedalaman (depth) ke Faster R-CNN (multimodal RGB-D), mengatasi keterbatasan visual 2D murni dari YOLOv3-dense.
- Hubungan dengan [Fruit Detection & 3D Location (Gene-Mola dkk.)](../entries/124%20-%202020%20-%20Fruit%20Detection%20&%203D%20Location%20(Gene-Mola%20dkk.)%20-%20Pertanian.md) dan [Fruit Detection & 3D Visualisation (Kang & Chen)](../entries/127%20-%202020%20-%20Fruit%20Detection%20&%203D%20Visualisation%20(Kang%20&%20Chen)%20-%20Pertanian.md): Kedua bab ini melangkah lebih jauh dari deteksi 2D YOLOv3-dense dengan menggunakan segmentasi instan (*instance segmentation*) dan rekonstruksi 3D (fotogrametri SfM atau sensor kedalaman aktif) untuk melokalisasi posisi buah secara presisi dalam ruang tiga dimensi.
- Hubungan dengan [Automated Fruit Harvesting Robot (Onishi dkk.)](../entries/126%20-%202019%20-%20Automated%20Fruit%20Harvesting%20Robot%20(Onishi%20dkk.)%20-%20Pertanian.md) dan [Iceberg Lettuce Harvesting Robot](../entries/125%20-%202020%20-%20Iceberg%20Lettuce%20Harvesting%20Robot%20-%20Pertanian.md): Deteksi visual 2D apel seperti yang dikembangkan oleh Tian dkk. merupakan komponen dasar sistem visi komputer yang kemudian diintegrasikan ke dalam sistem robot fisik pengeksekusi pemanenan buah otonom.
