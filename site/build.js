 ...
 *
 * Pemakaian:
 *   node site/build.js         -> tulis index.html di akar repo
 *   node site/build.js --dry   -> hanya laporan (tidak menulis berkas)
 *
...
function RUNTIME() {
  ...
  function enhance(container, e) {
    ...
    container.querySelectorAll('a[href]').forEach(function (a) {
      ...
      if (m && /docs\/literature\/withheld\//i.test(dec)) {
  ...
  function footHtml() {
    return '<footer class="foot rv"><span>' + META.total + ' entri · ' + META.themeCount + ' tema · dibangun ' + esc(META.built) + '</span>' +
      ...
      '<span>Regenerasi: <code>node site/build.js</code></span>' +
