...
\begin{figure*}[t]
\centering
\figplace{F01-taksonomi-gpt-image-2}{Taksonomi empat poros dan klaster tematik korpus 202 karya.}
...
\begin{figure*}[t]
\centering
\figplace{F03-silsilah-rgb-gpt-image-2}{Silsilah detektor RGB: dua-tahap, satu-tahap, anchor-free, dan transformer.}
...
\begin{figure*}[t]
\centering
\figplace{F04-strategi-fusi-gpt-image-2}{Tiga strategi fusi RGB-D: awal, menengah, akhir.}
...
\begin{figure*}[t]
\centering
\figplace{F06-atensi-lintasmodal-gpt-image-2}{Skema atensi lintas-modal antara aliran RGB dan Depth.}
...
\begin{figure*}[t]
\centering
\figplace{F05-pola-yolorgbd-gpt-image-2}{Dua pola integrasi YOLO+RGB-D: perluasan kanal vs deteksi-lalu-proyeksi.}
...
\begin{figure}[t]
\centering
\figplace{C01-distribusi-tahun-gpt-image-2}{Distribusi 202 entri per tahun publikasi (2012--2026).}
...
\begin{figure*}[t]
\centering
\figplace{C02-distribusi-tema-gpt-image-2}{Distribusi 202 entri per tema.}
...
\begin{figure*}[t]
\centering
\figplace{F07-funnel-sawit-gpt-image-2}{Corong dari survei umum menuju celah riset sawit.}
...
\begin{figure*}[t]
\centering
\figplace{F08-pipeline-sawit-gpt-image-2}{Pipeline usulan YOLO RGB-D untuk penghitungan dan klasifikasi buah sawit.}
