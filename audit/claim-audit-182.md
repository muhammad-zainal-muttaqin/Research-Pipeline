...
Every verified PDF in `literature/pdf/benar/` was extracted to `literature/extracted/<id>-<key>.md`
...
in each paper, and the full text of all 182 sources is in `literature/extracted/` for any
