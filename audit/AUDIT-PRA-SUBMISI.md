...
**Cakupan:** `manuscript/source/main.tex`, `main-elsarticle.tex`, `body.tex`, `manuscript/source/references.bib`,
...
|---|---|---|
| Dua driver naskah | Siap ditinjau | `manuscript/source/main.tex` (IEEEtran) dan `main-elsarticle.tex` (elsarticle) sama-sama memuat `body.tex`, sehingga isi utama tidak bercabang. |
...
202 kunci unik. Semua kunci tersebut ada pada `manuscript/source/references.bib`, dan tidak ada
...
- `Nama Penulis`, `Nama Pembimbing`, program studi, dan email pada `manuscript/source/main.tex`;
...
5. Putuskan status `legacy/tinjauan-pustaka.tex`: berkas tersebut adalah draf mandiri
   lama dan tidak diinput oleh `manuscript/source/main.tex` maupun `main-elsarticle.tex`. Isinya
...
10. Seragamkan tahun YOLOv7. Indeks, C01, dan `body.tex` memakai 2023, sementara
    `literature/synthesis.md` serta draf lama memakai 2022. Tetapkan apakah konvensi naskah
