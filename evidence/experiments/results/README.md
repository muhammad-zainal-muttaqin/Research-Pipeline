...
Angka mentah di balik [metrik final E-021](../../docs/eksperimen/METRICS.md),
[arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md), dan putusan
di [`../../docs/eksperimen/SR/`](../../docs/eksperimen/SR/). Berkas
...
| `E-021/` | `perkelas_pycoco.json` | E-021 | **Tabel 1-protokol** keempat model | [METRICS final](../../docs/eksperimen/METRICS.md) |
...
| `E-021/` | `yolo26l_eval.json` | E-021 | YOLO26l baseline param-adil | [METRICS final](../../docs/eksperimen/METRICS.md) |
| `E-022/` | `mi.json` | E-022a | Mutual information 4 kandidat pemetaan depth→RGB + kontrol pergeseran | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md), hasil teknis |
...
| `E-022/` | `pycoco_yolo26n.json` | E-022b | 1-protokol pycocotools YOLO26n RGB & RGB-D | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_yolo26n.json` | E-022b | Selisih berpasangan RGB-D terhadap RGB, CI per-kelas | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_rtdetrl.json` | E-022b | Idem, RT-DETR-L | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_rfdetrnano.json` | E-022b | Idem, RF-DETR Nano | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_derau.json` | E-022b | Kontrol negatif: kanal ke-4 derau terhadap RGB | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_yolo26n_depth_vs_derau.json` | E-022b | Isolasi kandungan informasi depth, YOLO26n | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_rtdetrl_depth_vs_derau.json` | E-022b | Idem, RT-DETR-L | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_rfdetrnano_depth_vs_derau.json` | E-022b | Idem, RF-DETR Nano | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
| `E-022/` | `paired_yolo26n_depth_vs_tukar.json` | E-022b | Kontrol registrasi: depth benar terhadap depth pohon lain | [Arsip E-022](../../docs/eksperimen/archive/E022-seed42-awal.md) |
