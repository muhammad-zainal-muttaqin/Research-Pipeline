...
`experiments/analysis/geometric_linking.py`, 141 pohon split uji (140 punya pose).
...
`docs/referensi/deep-research-report.md`.
...
`experiments/build/gen_depth_dataset.py`). Tanpa GPU; beberapa menit.
