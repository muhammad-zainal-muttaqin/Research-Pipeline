...
> **sudah dibuka.** `reproduce/experiments/build/match_raw.py` memetakan 3.992/3.992 citra lewat isi
> (tanda tangan citra ternormalkan), nol ambigu, skor terendah 0,9985. Master
> 3024×4032 kini dapat dipakai tanpa anotasi ulang; `reproduce/experiments/build/build_master_ds.py`
