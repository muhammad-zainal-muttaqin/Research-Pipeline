...
- **Kaitan dengan [128 - 2024 - Systematic Review YOLO Medis (Qureshi dkk.) - Medis](../entries/128%20-%202024%20-%20Systematic%20Review%20YOLO%20Medis%20(Qureshi%20dkk.)%20-%20Medis.md):** Makalah Mohiyuddin dkk. menjadi salah satu bukti empiris yang diulas dalam tinjauan sistematis tersebut mengenai efektivitas adaptasi YOLOv5 untuk segmentasi dan deteksi lesi klinis.
- **Kaitan dengan [130 - 2021 - Breast Lesion Detection (YOLO Fusion) - Medis](../entries/130%20-%202021%20-%20Breast%20Lesion%20Detection%20(YOLO%20Fusion)%20-%20Medis.md):** Kedua penelitian berfokus pada deteksi tumor payudara pada mamogram. Sementara YOLO Fusion menggunakan fusi fitur multi-resolusi secara horizontal untuk mengatasi kontras rendah, Mohiyuddin dkk. menyederhanakan arsitektur blok residu secara vertikal untuk menekan parameter komputasi.
- **Kaitan dengan [129 - 2021 - COVID-19 CAD dari X-Ray (Al-Antari dkk.) - Medis](../entries/129%20-%202021%20-%20COVID-19%20CAD%20dari%20X-Ray%20(Al-Antari%20dkk.)%20-%20Medis.md) dan [132 - 2023 - YOLO untuk Deteksi Polip (Wan dkk.) - Medis](132%20-%202023%20-%20YOLO%20untuk%20Deteksi%20Polip%20(Wan%20dkk.)%20-%20Medis.md):** Semua studi ini memodifikasi arsitektur standar YOLO untuk mendeteksi patologi organ tubuh (paru-paru dan usus besar) yang memiliki kontras rendah dan bentuk yang bervariasi, menekankan pentingnya pra-pemrosesan citra medis untuk menunjang performa detektor.
