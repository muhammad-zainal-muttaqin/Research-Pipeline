...
Keputusan yang melatarbelakangi: [`docs/naskah/REFRAME-DECISIONS.md`](../naskah/REFRAME-DECISIONS.md).
...
Agriculture* 2026 yang dibedah (`docs/referensi/revisi-dosen-2026-07-23/`), **0/8** meregistrasi protokol,
