...
- [ ] Jalankan: `node site/build.js --dry` (mode laporan saja, belum menulis HTML)
...
- [ ] `node site/build.js` → `index.html` final; verifikasi ukuran & laporan
...
7. `node site/build.js` meregenerasi file identik-fungsional kapan pun.
